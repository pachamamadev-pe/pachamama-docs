...
- **Mensajería:** zure-messaging-servicebus 7.17.6 (para colas/tópicos de Azure)
- **Persistencia:** Spring Boot Starter Data MongoDB
- **Proveedores de Notificación:** irebase-admin 9.3.0
...
- **Tópicos Azure (Service Bus):** Es consumidor (sub:send-notifications) desde tópico ssigned-brigade para reaccionar a una asignación y notificar al usuario final.
